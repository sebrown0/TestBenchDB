...
SELECT 		ts.test_suite_name, get_max_ver_for_test_suite(ts.id) AS test_suite_version, ts.id AS test_suite_row_id,
			...
			test.entity_test_name, get_max_ver_for_entity_test(test.id) AS entity_test_version, test.description AS test_description, 
			...
			ent.entity_name, get_max_ver_for_entity(ent.id) AS entity_version, ent.entity_type_entity_type_name AS entity_type,
