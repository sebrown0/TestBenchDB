...
SELECT * FROM test_bench.entity WHERE id = 1307;
SELECT * FROM test_bench.element WHERE entity_row_id = 10260;
SELECT * FROM test_bench.entity WHERE id > 9000 ORDER BY id DESC;
SELECT * FROM test_bench.entity WHERE entity_name = 'ElementTestSuite';
...
SELECT * FROM test_bench.entity_help where entity_id = 1309;
SELECT * FROM test_bench.entity_details ORDER BY id DESC;
SELECT * FROM test_bench.entity_details where id = 1623;
...
/*
CALL delete_entity_and_tests(1309,1306);
