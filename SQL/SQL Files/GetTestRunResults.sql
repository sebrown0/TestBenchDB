SET @TEST_RUN_ID_FOR_THIS_QUERY = 1;
SELECT 
...
CALL get_test_results_for_run_by_category(@TEST_RUN_ID_FOR_THIS_QUERY,'FAIL');
CALL get_test_results_for_run_by_category(@TEST_RUN_ID_FOR_THIS_QUERY,'QP');
CALL get_test_results_for_run_by_category(@TEST_RUN_ID_FOR_THIS_QUERY,'NR');
CALL get_test_results_for_run_by_category(@TEST_RUN_ID_FOR_THIS_QUERY,'PASS');